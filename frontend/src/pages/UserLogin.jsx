  ...
  return (
    <div className="p-7 flex flex-col justify-between h-screen">
      <div>
        ...
        <form>
          <h3 className="text-lg mb-2 font-medium capitalize">What's your email?</h3>
          <input
          ...
          <h3 className="text-lg mb-2 font-medium capitalize">What's your password?</h3>
          <input
            type="password"
            value={password}
      ...
      <div>
        <button
          className="bg-[#ff1010] text-white font-semibold tracking-wide rounded w-full py-2 transition duration-300 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500"
        >
          Sign in as Captain
        </button>
      </div>
